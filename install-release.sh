...
download_xray() {
  DOWNLOAD_LINK="https://gh.con.sh/https://github.com/XTLS/Xray-core/releases/download/${INSTALL_VERSION}/Xray-linux-${MACHINE}.zip"
...
install_geodata() {
  ...
  local download_link_geoip="https://gh.con.sh/https://github.com/v2fly/geoip/releases/latest/download/geoip.dat"
  local download_link_geosite="https://gh.con.sh/https://github.com/v2fly/domain-list-community/releases/latest/download/dlc.dat"
